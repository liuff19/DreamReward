ckpt_reward="checkpoints/Reward3D_Scorer.pt"
gpu=7
name="Scorer2"
configs_neme="configs/dreamreward2.yaml"
alg_type="Reward3D_Scorer"
guidance_type="DreamReward-guidance2"
#prompt1:pen and manuscripts
